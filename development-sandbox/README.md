...
- `SANDBOX_CPUS` / `SANDBOX_MEMORY` / `SANDBOX_DISK` override VM resources at creation time (defaults: `4`, `8G`, `40G`). Note: Currently hardcoded in `scripts/sandbox.sh` and these environment variables and CLI flags are not yet functional.
