...
run_step wiring_runner "grep -q '\"validators-$VALIDATOR\"' validators/runner/pyproject.toml"
run_step wiring_root "grep -q '^validators-$VALIDATOR = { path = \"./validators/$VALIDATOR\", develop = true }' pyproject.toml"
