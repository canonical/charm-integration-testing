...
class TestJubilantBackend:
    ...
    class TestControllerSetupRetries:
        ...
        class SetupStub:
            ...
            def bootstrap(self, cloud: str, controller: str, bootstrap_constraints: dict[str, str], metadata_source: str | None = None, config: dict[str, str] | None = None) -> None:
        ...
        def test_bootstrap_controller_retries_then_succeeds(self) -> None:
            ...
            with patch("tenacity.nap.sleep", return_value=None):
                backend.bootstrap_controller(cloud="k8s-stg", controller="test-controller", controller_constraints={}, bootstrap_configuration={})
