...
class TestNormalizeTempFiles:
    ...
    test_cases = [
        ...
        Params(
            ...
            expected="/home/ubuntu/snap/juju/common/tmpXXX",
        ),
        Params(
...
class TestNormalizeMinioProbeUrls:
    ...
    test_cases = [
        Params(
            ...
            expected="probe-bsign-XXX",
        ),
        Params(
            label="probe_in_url",
            input="http://10.1.1.1:9000/probe-bsign-rhudephrbcvyt",
            expected="http://10.1.1.1:9000/probe-bsign-XXX",
        ),
        Params(
        ...
        Params(
            ...
            expected="probe-bsign-XXX and probe-bsign-XXX",
        ),
        Params(
            label="no_probe",
            input="hello world",
...
class TestNormalizeOciImageDigests:
    ...
    test_cases = [
        ...
        Params(
            ...
            expected='Back-off pulling image "registry.io/app/oci-image@sha256:XXX"',
        ),
        Params(
...
class TestNormalizeString:
    ...
    test_cases = [
        ...
        Params(
            ...
            expected="crash loop backoff: back-off XXXmXXXs restarting failed container=ml-pipeline-persistenceagent pod=XXX",
        ),
        Params(
            ...
            expected="Command ['juju', 'add-secret', '--model', 'model-XXX-XXX', 'vault-secret', '--file', '/home/ubuntu/snap/juju/common/tmpXXX']",
        ),
        Params(
            label="minio_connection_error",
            input='mc: <ERROR> Get "http://10.152.183.123:9000/probe-bsign-rhudephrbcvytabcxipksqdefwjve"',
            expected='mc: <ERROR> Get "http://XXX.XXX.XXX.XXX:XXX/probe-bsign-XXX"',
        ),
        Params(
            ...
            expected='Back-off pulling image "registry.jujucharms.com/kubeflow-charmers/katib-manager/oci-image@shaXXX:XXX"',
        ),
        Params(
            ...
            expected="model-XXX/pod=XXX/image@shaXXX:XXX",
        ),
        Params(
        ...
        Params(
            ...
            expected="juju add-secret --model model-XXX-XXX vault-secret-application-target-tokens --file /home/ubuntu/snap/juju/common/tmpXXX",
        ),
        Params(
