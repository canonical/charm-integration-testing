...
"""Sources that collect resource snapshots from a live cluster.

Each source knows how to turn one kind of raw cluster object into
...
does) while all snapshot construction lives alongside the tracker that consumes
it.  New resource kinds are supported by adding another source.
"""
...
class ResourceSource(Protocol):
    """Collects snapshots of a single resource kind for one model."""
